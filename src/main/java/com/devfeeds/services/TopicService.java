...
public class TopicService {
    ...
    public Page<Comment> getTopicComments(@RequestParam long topicId,
    		@RequestParam int page,@RequestParam int size){
    	return topicMetier.getCommentTopic(topicId,page,size);
	}
    
    @RequestMapping(value="/api/topics/popular",method=RequestMethod.GET)
    public Page<Topic> getPopularTopics(
    		@RequestParam int page,@RequestParam int size){
    	return topicMetier.getPopularTopics(page,size);
	}
